...
from .constants import TOOLTIP_TEMPLATE_CHOICES


@plugin_pool.register_plugin
class TooltipPlugin(AttributesMixin, BackgroundMixin, ForegroundMixin, CMSUIPlugin):
    name = _("Tooltip")
    module = _("Frontend")
    model = models.Tooltip
    form = forms.TooltipForm
    allow_children = True
    ...
    def get_render_template(self, context, instance, placeholder):
        return get_plugin_template(
            instance, "tooltip", "tooltip", TOOLTIP_TEMPLATE_CHOICES
        )
